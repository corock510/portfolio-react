        ...
        <div className="container">
          ...
          <div className="profile">
            ...
            <div className="profile-body">
              {/* <ul>
                <li>東京都在住 無職の29歳 Webエンジニアをやってます。</li>
                <li>2012年にバンドで売れるために岩手から上京。ピコリーモバンドで精力的に活動するも芽が出なかったため冷静に就職。</li>
                <li>2016年に新卒で金融系SIerに就職し、右も左も分からぬまま汎用系ソフトウェア案件のプロジェクトマネージャーを担当。</li>
                <li>2019年に小売系Webアプリ開発会社に転職し、Webアプリの主にバックエンドの開発に3年ほど従事したが、残業が月160時間を越え限界突破して退職。</li>
                <li>2022年に医療系Webアプリ開発会社に転職し、Webアプリのフロントエンド・バックエンドの開発に従事。プロジェクトマネージャーも兼任。</li>
                <li>その傍ら、フリーのWebエンジニアとしても活動中。現在に至る。</li>
              </ul> */}
